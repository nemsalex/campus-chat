    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('etudiant', 'Étudiant'), ('professeur', 'Professeur'), ('administration', 'Administration'), ('admin_principal', 'Admin principal')], default='etudiant', max_length=20)),
